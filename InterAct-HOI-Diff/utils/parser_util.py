...
def add_base_options(parser):
    ...
    group.add_argument("--seed", default=11, type=int, help="For fixing random seed.")
    group.add_argument("--batch_size", default=64, type=int, help="Batch size during training.")
    group.add_argument("--guidance", default=False, action="store_true",  help="whether use guidance learning ")  
    group.add_argument("--skip_first_stage", default=True, action="store_true",  help="whether skip stage 1 for affordance prediction")
...
def add_diffusion_options(parser):
    ...
    group.add_argument("--predict_xstart", default=True, type=bool, help="Predict xstart.")  
...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='behave', choices=['humanml', 'behave', 'omomo'], type=str,
...
def add_training_options(parser):
    ...
    group.add_argument("--t_bar",  type=int, default=700,
...
def add_obj_options(parser):
    ...
    group.add_argument("--pretrained_path", default='./checkpoints/behave_enc_512/model000001000.pt', type=str,
    ...
    group.add_argument("--multi_backbone_split", default=4, type=int, help="Where to cut? 0 is at the start, num_layers at the end.")
    group.add_argument("--multi_mdm_freeze", default=0, type=int, help="If true freeze MDM.")
...
def add_sampling_options(parser):
    ...
    group.add_argument("--model_path", default='./save/behave_enc_512/model000001000.pt', type=str,
...
def add_evaluation_options(parser):
    ...
    group.add_argument("--guidance_param", default=2.5, type=float,
                       help="For classifier-free sampling - specifies the s parameter, as defined in the paper.")
    group.add_argument("--model_path", default='./save/behave_enc_512/model0000200000.pt', type=str,
                       help="model path of human motion generation")
