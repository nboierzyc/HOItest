...
### 4. Train your HOI-DM
```
python -m train.hoi_diff --save_dir /media/volume/InterAct/save/all5_enc_1024 --dataset behave --save_interval 20000 --num_steps 100000 --arch trans_enc --batch_size 64
```

```
python -m train.hoi_diff --save_dir ./save/test --dataset behave --save_interval 10000 --num_steps 30000 --arch trans_enc --batch_size 8
```
...
```
python -m sample.local_generate_obj --model_path ./save/behave_enc_512_bps/model000030012.pt --num_samples 1 --num_repetitions 1 --motion_length 10 --multi_backbone_split 4 
```
Generate from your text file
```
python -m sample.local_generate_obj --model_path ./save/behave_enc_512/model000010000.pt --num_samples 10 --num_repetitions 1 --motion_length 10 --multi_backbone_split 4 
```
